...
export const products = [
   ...
   { id: 10, name: "Pahadi Potato - New Crop (Alu)", category: "Vegetables", price: 29, image: potato2, quantity:"(0.95-1.05) kg", unit:1 },
   { id: 11, name: "Green Capsicum (Shimla Mircha)", category: "Vegetables", price: 23, image: shimla, quantity:"(250-280) g", unit:1 },
   { id: 12, name: "Raw Papaya", category: "Vegetables", price: 48, image: papaya, quantity:"1 piece (400-600 g)", unit:1 },
